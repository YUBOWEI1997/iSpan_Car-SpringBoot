...
<!--     content -->
    ...
    <div class="row rounded">
     <div class="col-1" style="padding:0"></div>
      <div class="col-10 bg-white justify-content-center text-center rounded" style="padding:0">
...
<!--     <script src="http://localhost:8080/iSpanCar/script/js/scripts.js"></script> -->
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    var orderDates = document.getElementsByClassName("order-date");
	  ...
	  $(function(){
// 		  $('.navdiv').css('margin','0 99.6px')
// 		  $('.navdiv').css('margin-left','99.6px')
// 		  $('.navdiv').css('margin-right','99.6px')
// 		  $('#navbarResponsive').css('width','1164.4px')
// 		  $('#navbarResponsive').css('margin-left','auto')
