...
<body id="page-top">
    ...
    <footer class="footer bg-black small text-center text-white-50">
        <div class="container px-4 px-lg-5"><a class="nav-link"  href = "/backstage/memberchartjs" >Copyright &copy; Your Website 2022</a></div>
    </footer>
    ...
    <script>
    $(function(){
    	if($('#logincheck').val() != ""){//一般登入
    		var account = $('#logincheck').val();
    		var name = $('#loginName').val();
    		var orderhtml = '<li class="nav-item login-info"><b><a class="nav-link colorchange" href="/order" style="color:white;font-size:1.3em;font-family: \'Noto Sans TC\', sans-serif;">訂單</a></b></li>';
    		...
    		$('.login-info').before(orderhtml).html(loginhtml).after(logouttext);
    	}else{
    		if($('#logincheck2').val() != ""){//google登入
